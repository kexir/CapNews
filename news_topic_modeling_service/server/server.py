...
class RequestHandler(pyjsonrpc.HttpRequestHandler):
    ...
    def classify(self, text):
        logger.info('calling news_topic_modeling_server classify')
...
logger = logging.getLogger('news_topic_modeling_server')
logger.setLevel(logging.DEBUG)
# create file handler which logs even debug messages
fh = logging.FileHandler('news_topic_modeling_server.log')
...
logger.info('creating an instance of news_topic_modeling_server')
